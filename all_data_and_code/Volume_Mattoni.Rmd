---
title: "Dashboard for Volume Mattoni 1873"
output: 
...
library(readxl)
library(shiny)
startData <- read_excel("Mattoni1873_Volume.xlsx")
...
renderPlot({
 updateData() %>% 
  ...
  geom_col() + ggtitle("Plotting Volume of Mattoni 1873. Y(month in 2019) - Units in 1000 LTRS") + mynamestheme
})
```
