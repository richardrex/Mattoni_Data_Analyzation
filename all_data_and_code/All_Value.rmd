---
title: "Dashboard for Value All Companies"
output: 
...
library(readxl)
library(shiny)
startData <- read_excel("All_Value.xlsx")
...
renderPlot({
 updateData() %>% 
  ...
  geom_col() + ggtitle("Plotting Value of All Brands from Mattoni Dataset. Y(month in 2019) - Units in 1000000 CZK") + mynamestheme
})
```
