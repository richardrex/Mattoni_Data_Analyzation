---
title: "Dashboard for Volume All Companies"
output: 
...
library(readxl)
library(shiny)
startData <- read_excel("All_Volume.xlsx")
...
renderPlot({
 updateData() %>% 
  ...
  geom_col() + ggtitle("Plotting Volume of All Brands from Mattoni Dataset. Y(month in 2019) - Units in 1000 LTRS") + mynamestheme
})
```
