---
title: "Dashboard for Value Mattoni 1873"
output: 
...
library(readxl)
library(shiny)
startData <- read_excel("Mattoni1873_Value.xlsx")
...
renderPlot({
 updateData() %>% 
  ...
  geom_col() + ggtitle("Plotting Value of Mattoni 1873. Y(month in 2019) - Units in 1000000 CZK") + mynamestheme
})
```
